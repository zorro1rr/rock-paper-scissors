...
const clickHandler = function (event) {
  ...
  directions.innerHTML =
    '<p>Computer Choosing...</p><img src="images/arrowR.png" alt="arrow">';
  ...
  const decider = function () {
    ...
    const blueRock =
      '<button type="button" id="btn1" name="rock"><img src="images/rock L.png" alt="rock" style="background-color: blue;" style="color: blue;"></button>';
    const bluePaper =
      '<button type="button" id="btn2" name="paper"><img src="images/paper n.png" alt="paper" style="background-color: blue;" style="color: blue;"></button>';
    const blueScissor =
      '<button type="button" id="btn3" name="scissors"><img src="images/scissor OJ R.png" alt="scissors" style="background-color: blue;" style="color: blue;"></button>';

    if (computerChoices[computerChoice] === "rock") {
      img1.innerHTML =
        '<button type="button" style="background-color: red;" style="color: red;"><img src="images/rock L.png"  alt="rock"></button>';
      setTimeout(function () {
    ...
    if (computerChoices[computerChoice] === "paper") {
      img2.innerHTML =
        '<button type="button"  style="background-color: red;" style="color: red;"><img src="images/paper n.png" alt="paper"></button>';
      setTimeout(function () {
    ...
    if (computerChoices[computerChoice] === "scissors") {
      img3.innerHTML =
        '<button type="button"  style="background-color: red;" style="color: red;"><img src="images/scissor OJ R.png" alt="scissors"></button>';
      setTimeout(function () {
        directions.innerHTML = "The Computer chooses scissors!";
        if (userInput === "rock") {
          btn1.style = "background-color: blue;";
          winHandler();
        } else if (userInput === "scissors") {
          btn3.outerHTML = blueScissor;
          tieHandler();
